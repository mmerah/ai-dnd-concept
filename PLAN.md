...
The phased plan for what is built next, in order. The transaction kernel, Cairn 2e and Phase 1's
three-part refactor all shipped 2026-08-14 and now live in PROGRESS.md. Phase 2 is the scenario
creator, Phase 3 media. Each phase carries enough detail to implement without prior context; only
