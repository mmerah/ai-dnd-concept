from twentyfourxx_test_support import JOB, LOCKPICKS, hub_world, small_world
...
def test_player_view_jobs_panel_is_titled_jobs_and_has_a_row_after_a_return() -> None:
    game = hub_world()
    world = game.payload.world
