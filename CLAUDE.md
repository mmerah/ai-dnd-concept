...
- The world is whatever its engine-selected kit says it is: the scene kit under `src/aidm/kits/scenes/` owns sentence-driven scenes. Each kit owns its state, `change_world` verbs, boundary, and views.
