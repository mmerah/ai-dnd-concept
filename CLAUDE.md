...
- Each engine owns all of its mechanics. It defines the overlay schema for authored content, treats incompatible state as invalid, and gives entities created during play a default rules model.
