...
- Official downloads on itch.io: <https://natetreme.itch.io/tunnelgoons>. Files: `Tunnel Goons
  ...
  sheets, and Portuguese, Italian and Spanish translations. itch.io's download needs a browser
  click; the PDFs were not read for this file.
...
lines, which match CC BY 4.0, but no page links the deed or names the variant. Copy the licence
line verbatim from the PDF before shipping `rules.md`; if it is BY-SA, `rules.md` carries
ShareAlike as Loner's does.

Attribution until the PDF line replaces it:
