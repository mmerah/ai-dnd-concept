...
class Dnd5eTools:
    ...
    def attack(
        ...
        """
        return self._apply(
            ctx.deps, lambda world: combat.attack(world, weapon, target_id, attacker_id)
        )
    ...
    def _saved(
        ...
        return [*common.reveal(world, target), rolled.fact]
    ...
    def damage(
        ...
        """
        return self._apply(
            ctx.deps, lambda world: health.hp_facts(world, target_id, amount, sign=-1)
        )
    ...
    def apply_condition(
        ...
        """
        return self._apply(
            ctx.deps, lambda world: conditions.change(world, target_id, condition, ends=ends)
        )
