...
WHAT THIS SCENE IS ABOUT says what the scene is for. Play it out.

Call `next_scene` with nothing set when the scene reaches a stopping point. A scene reaches a
stopping point when the player has answered what the scene is for, refused it, or made it moot.
