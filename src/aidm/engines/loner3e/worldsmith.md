...
3. After the opening, one thing already established: a person, an object, a place, or a rumour. It does not have to be a person, and a person needs a reason to be there — the party follows the player from scene to scene; nobody else does. Somebody the player left behind stays behind until the story brings them back.
