...
Call it with no arguments once, when the whole adventure ends. The tool opens the pick to the player themselves: one ability up by 1, and Health or Inventory up by 1. In a campaign, call it when the job's dungeon is done; the tavern then closes the job as finished.
...
When WAYS OUT lead nowhere new, the page offers the player more map, and at the tavern it offers work; nothing for you to call.
