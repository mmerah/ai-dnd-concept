...
2. Follow the briefing's engine guidance for which new entities need a sheet: an NPC sheet goes
   under `mechanics` keyed by id. Use selected-pack vocabulary where the engine requires it; some
