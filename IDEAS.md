...
- [] 0: Refactors once PLAN.md is in: ponytail-audit + Minimal engines so that there is as little deviations for each as possible + Simplification of codebase if any available
