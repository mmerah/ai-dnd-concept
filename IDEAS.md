...
- Phase 0: L1, I3.
- Phase 1: L3 (measure only), L6 (read only, decide, don't fix).
- Phase 2: L5 + L2 death half.
- Phase 3: L7.
- Phase 4: L6 fixes, L8, L9, L11, L10, I4, I2.
- Never: L12. Only if L3 proves it: L4, L2 state-keeper half.